...
import finki.ukim.mk.services.impl.BaseOAuthServiceImpl;
...
public class TwitterModule {
	public static void bind(ServiceBinder binder) {
		...
		binder.bind(BaseOAuthService.class, BaseOAuthServiceImpl.class);
		binder.bind(OAuthResource.class, Tweet.class);
		// binder.bind(TwitterService.class, TwitterServiceImpl.class);
	...
	public TwitterService buildTwitterService() {
		...
		OAuthConfiguration configurer = new OAuthConfiguration(
				"RejyI77tF7kBr2BgTCJ10A",
				"1TI5I6TN32g9Gwe1n7y5o7ikAm9Za22LSnKwUH0A",
				"http://127.0.0.1:9090/tweet.twitterconnect:authorize");

		return new TwitterServiceImpl(configurer,
				OAuthConstants.DEFAULT_TWITTER_API_PREFIX);
	}
